...
public class ErrorHandler {
    ...
    public static void showSintaxError(FileIterator iterator, FDAException exception){
        Console.printError("SYNTAX ERROR",Console.ANSI_WHITE+exception.getMessage()+ Console.ANSI_PURPLE+" in line "+ iterator.getLine() +Console.ANSI_BLUE +" ["+Console.avoidScapes(Character.toString((Character) iterator.getCurrentElement()))+"]"+Console.ANSI_WHITE+" with syntax code " +exception.getErrorCode()+"\n");
    }
    public static void showSemanticError(FileIterator iterator, FDAException exception){
        Console.printError("SEMANTIC ERROR",Console.ANSI_WHITE+exception.getMessage()+ Console.ANSI_PURPLE+" in line "+ iterator.getLine() +Console.ANSI_BLUE +" ["+Console.avoidScapes(Character.toString((Character) iterator.getCurrentElement()))+"]"+Console.ANSI_WHITE+" with semantic code " +exception.getErrorCode()+"\n");
    }
